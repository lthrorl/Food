...
function forms(formSelector, modalTimeId) {
  ...
  function showThanksModal(message) {
    ...
    thanksModal.innerHTML = "\n        <div class='modal__content'>\n            <div class='modal-close' date-close>\xD7</div>\n            <div class='modal-title'>".concat(message, "</div>\n        </div>\n        ");
...
function modal(triggerSelector, modalSelector, modalTimeId) {
  ...
  modal.addEventListener('click', function (e) {
    if (e.target === modal || e.target.getAttribute('date-close') == '') {
...
window.addEventListener('DOMContentLoaded', function () {
  var modalTimeId = setTimeout(function () {
    return (0,_modules_modal__WEBPACK_IMPORTED_MODULE_2__.openModal)('.modal', modalTimeId);
  }, 500000);
